...
import de.uk.java.feader.data.SortableListModel;
...
public class FeaderGUI extends JFrame implements ActionListener, PropertyChangeListener {
	...
	private SortableListModel<Feed> feedsListModel;
	...
	private Component initFeedsList() {
		...
		feedsListModel = new SortableListModel<>();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "sortFeeds": sortFeeds(); break;
